# Codex Agent: Feature Orchestrator
...
Primary Codex routing guidance:
...
- until Codex exposes a richer native orchestrator surface, this adapter uses `role-routing.md` as the orchestrator fallback
