...
| Environments management | `/environment` | environment scheduler and environment APIs | role-restricted | `Admin` or `EnvironmentManager` | [feature-spec.md](../../specs/features/FEAT-ENVIRONMENTS-001-management/feature-spec.md) | Keep frontend, backend, and docs aligned on allowed roles |
