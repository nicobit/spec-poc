...
- `FEAT-ADMIN-002 Environments Management` owns the stage authoring experience for supported Azure service types
- `FEAT-ADMIN-002 Environments Management` owns collection and validation of the type-specific execution properties entered by users
- `FEAT-ADMIN-004 Start/Stop Services` consumes those configured stage resource actions and defines how they are executed at runtime
...
- `specs/features/FEAT-ADMIN-004-start-stop-services/`
