...
- Supported Azure service types and their required properties are configured inside stage editing in `FEAT-ENVIRONMENTS-001 Environments Management`
...
- Relationship to `FEAT-ENVIRONMENTS-001 Environments Management` clarified
