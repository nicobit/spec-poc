...
- Every code-change PR must point to the spec and test plan it implements.
-->
...
- [ ] This PR does not implement behavior outside the linked spec
- [ ] If the request started as raw business input, `business-request.md` / `spec-refinement.md` were created or updated first

Include links to the spec and test plan in the PR description.

## Checklist
- [ ] Code compiles and tests pass
- [ ] Documentation (README or per-feature docs) updated if needed
- [ ] Authorization docs updated if routes, roles, or access rules changed
- [ ] Feature owner and tech owner reviews requested (see CODEOWNERS)
